...
netsh advfirewall firewall add rule name="NUT - Corel License" dir=in action=block program="%ProgramFiles% (x86)\Common Files\Protexis\License Service\PsiService_2.exe" profile=any description="%ProgramFiles% (x86)\Common Files\Protexis\License Service\PsiService_2.exe"
netsh advfirewall firewall add rule name="NUT - CorelDRAW" dir=in action=block program="%ProgramFiles%\Corel\CorelDRAW Graphics Suite X8\Programs64\CorelDRW.exe" profile=any description="%ProgramFiles%\Corel\CorelDRAW Graphics Suite X8\Programs64\CorelDRW.exe"
netsh advfirewall firewall add rule name="NUT - CorelConverter" dir=in action=block program="%ProgramFiles%\Corel\CorelDRAW Graphics Suite X8\Programs64\CdrConv.exe" profile=any description="%ProgramFiles%\Corel\CorelDRAW Graphics Suite X8\Programs64\CdrConv.exe"
netsh advfirewall firewall add rule name="NUT - DIM" dir=in action=block program="%ProgramFiles%\Corel\CorelDRAW Graphics Suite X8\Programs64\DIM.exe" profile=any description="%ProgramFiles%\Corel\CorelDRAW Graphics Suite X8\Programs64\DIM.exe"
netsh advfirewall firewall add rule name="NUT Corel UI Server" dir=in action=block program="%ProgramFiles%\Corel\CorelDRAW Graphics Suite X8\Programs64\CrlUISvr.exe" profile=any description="%ProgramFiles%\Corel\CorelDRAW Graphics Suite X8\Programs64\CrlUISvr.exe"
netsh advfirewall firewall add rule name="NUT Corel CUH" dir=in action=block program="%ProgramFiles(x86)%\Corel\CUH\v2\CUH.exe" profile=any description="%ProgramFiles(x86)%\Corel\CUH\v2\CUH.exe"
netsh advfirewall firewall add rule name="NUT Corel DimChain" dir=in action=block program="%ProgramFiles(x86)%\Corel\CUH\v2\dimchain.exe" profile=any description="%ProgramFiles(x86)%\Corel\CUH\v2\dimchain.exe"
netsh advfirewall firewall add rule name="NUT Corel DIM" dir=in action=block program="%ProgramFiles(x86)%\Corel\CUH\v2\DIM.exe" profile=any description="%ProgramFiles(x86)%\Corel\CUH\v2\DIM.exe"
